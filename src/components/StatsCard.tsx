...
export function StatsCard() {
  ...
  return (
    ...
    >
      ...
      >
        <h3 className="text-xl sm:text-2xl font-bold text-white mb-2">Statistics</h3>
        <p className="text-[#92c9c9] text-xs sm:text-sm text-center">View election statistics</p>
      </div>
    </div>
  );
}
